...
class Arena:
    @staticmethod
    #Se inicializan los puntajes de ambos bots y las jugadas previas como None.
    def Jugar(bot1: BotAbstract, bot2: BotAbstract):
        ...
        print("-" * 80)
        #Se ejecuta un bucle de 20 iteraciones (rondas).
        for i in range(20):
            #Cada bot realiza su jugada con el método Jugar, utilizando la jugada previa del oponente como referencia.
            ...
            #Se calcula el puntaje de la jugada usando el método estático calcular_puntaje_jugada de la clase Arbitro
        ...
        #Al final de las 20 rondas, se imprimen los puntajes finales de ambos bots.
